...
if __name__ == "__main__":
    # Replace with a valid user ID from your Microsoft Entra ID tenant
    TEST_USER_ID = "3a971bab-cb9c-4f1c-a36a-051f5ddbd339"  # e.g., "12345678-1234-1234-1234-1234567890ab"
    TEST_TICKET_ID = 16  # Test ticket ID
